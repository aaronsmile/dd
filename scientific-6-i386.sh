...
CentOSMirror="http://sunsite.icm.edu.pl/pub/Linux/dist/scientificlinux/6/i386/os/isolinux"
mkdir -p /ddreinst
...
url --url="http://sunsite.icm.edu.pl/pub/Linux/dist/scientificlinux/6/i386/os/"
# Root password
