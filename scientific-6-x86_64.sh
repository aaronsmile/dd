...
CentOSMirror="http://sunsite.icm.edu.pl/pub/Linux/dist/scientificlinux/6/x86_64/os/isolinux"
mkdir -p /ddreinst
...
url --url="http://sunsite.icm.edu.pl/pub/Linux/dist/scientificlinux/6/x86_64/os/"
# Root password
